...
'''
# 执行查询语句
select_query = '''INSERT INTO multidept_emp2 (emp_no, name, dept_no, manager_no)
select tmp1.emp_no, tmp1.name, tmp1.dept_no, min(dm.emp_no) as maneger_no
from(
...
) as dm on tmp1.dept_no = dm.dept_no
...
# 将结果插入新表
insert_query = '''INSERT INTO multidept_emp2 (emp_no, name, dept_no, manager_no)
                  VALUES (%s, %s, %s, %s)'''
